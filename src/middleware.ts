...
export function middleware(request: NextRequest) {
  try {
    ...
    const cspConnectSrc =
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.vercel.app https://vercel.live https://va.vercel-scripts.com https://vitals.vercel-insights.com https://maps.googleapis.com https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://connect.facebook.net https://www.facebook.com https://graph.facebook.com https://an.facebook.com https://*.facebook.com https://*.fbsbx.com https://www.clarity.ms https://scripts.clarity.ms https://f.clarity.ms https://v.clarity.ms https://*.clarity.ms https://demo-1.conversionsapigateway.com https://*.conversionsapigateway.com;"
