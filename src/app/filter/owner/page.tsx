    ...
    <div className={`${fraunces.variable} ${plusJakarta.variable} min-h-screen relative overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12 opacity-0 animate-[fadeInUp_0.8s_ease-out_forwards]">
          <div className="inline-flex items-center px-2.5 sm:px-4 md:px-5 py-1 sm:py-1.5 sm:py-2 bg-gradient-to-r from-[#E4002B]/10 to-[#FF5200]/10 backdrop-blur-sm rounded-full mb-3 sm:mb-4 md:mb-5 border border-[#E4002B]/30">
            <span className="w-1.5 h-1.5 bg-gradient-to-r from-[#E4002B] to-[#FF5200] rounded-full mr-1.5 sm:mr-2.5 animate-pulse"></span>
            <span className="text-[10px] sm:text-xs md:text-sm font-medium text-gray-700">Property Listing</span>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 sm:mb-3 px-2 sm:px-4">
