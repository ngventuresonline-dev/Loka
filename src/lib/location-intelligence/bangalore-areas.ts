...
export const BANGALORE_PINCODES: Array<{ pincode: string; name: string; lat: number; lng: number }> = [
  ...
  { pincode: '560016', name: 'Rammurthy Nagar', lat: 13.021, lng: 77.668 },
  ...
  { pincode: '560043', name: 'Kasturi Nagar / Kalyan Nagar', lat: 13.018, lng: 77.648 },
  ...
  { pincode: '560076', name: 'BTM Layout / Hulimavu', lat: 12.917, lng: 77.610 },
  { pincode: '560077', name: 'Hegde Nagar / Thanisandra', lat: 13.058, lng: 77.624 },
  { pincode: '560078', name: 'JP Nagar', lat: 12.906, lng: 77.586 },
  { pincode: '560088', name: 'Hessarghatta', lat: 13.139, lng: 77.478 },
