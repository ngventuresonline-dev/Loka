...
3. COMPETITORS: For ${brand.industry || brand.category || 'this brand category'}, name the ACTUAL competitors in this area by brand name — **in the same format the brand operates** (do not substitute North Indian dining for QSR/snack). For eyewear/optical retail: Lenskart, Vision Express, Specsmakers, GKB Opticals. For café: Blue Tokai, Third Wave Coffee, Starbucks, Matteo Coffea. For Indian QSR / vada pav / snack chains: Jumbo King, Goli Vada Pav, Wow! Momo, McDonalds, KFC, and similar takeaway/snack formats — not full-service biryani or North Indian unless the brand is that format. For salon: Naturals, Bounce, Jean-Claude Biguine. Use localityIntel saturation signals (cafeSaturation, qsrSaturation etc.) and the competitors array (with reviews as demand proxy) to assess how crowded the market is FOR THIS SPECIFIC BRAND CATEGORY. High review counts on existing outlets = strong demand validation, not only a threat.
