...
('prop-001', 'Premium Cafe Space in Indiranagar', 'High-footfall location perfect for specialty coffee chains and QSR brands with modern interiors.', '100 Feet Road, Indiranagar', 'Bangalore', 'Karnataka', '560038', 85000, 'monthly', 510000, 5.00, 1200, 'retail', '15 KW', TRUE, TRUE, '["WiFi", "Parking", "Air Conditioning", "Kitchen Setup", "Street Facing"]'::jsonb, '["https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1200&auto=format&fit=crop&q=80"]'::jsonb, 'owner-001'),
