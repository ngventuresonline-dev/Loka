...
WITH zones(idx, name, lat0, lat1, lng0, lng1) AS (VALUES
  ...
  ( 9,'BTM Layout',      12.892,12.938,77.568,77.618),
  ...
  (29,'RT Nagar',        12.998,13.048,77.555,77.618),
  (30,'Hebbal',          13.022,13.082,77.540,77.628),
  (31,'Sahakar Nagar',   13.038,13.095,77.545,77.622),
  (32,'Manyata',         13.025,13.082,77.598,77.668),
  (33,'Thanisandra',     13.045,13.098,77.598,77.672),
